...
autenticacao). Mesma formula exata do `baixar_chuva_positivos_lead_a.py` (SUSC-20B):
...
`open_meteo_era5_land_archive_api`, `v12_estatisticas_ortogonalizacao.json`, SUSC-20C) --
...
# (v12_estatisticas_ortogonalizacao.json, SUSC-20C) -- reusados, nao refeitos.
ORTHO_BETA = 0.392
