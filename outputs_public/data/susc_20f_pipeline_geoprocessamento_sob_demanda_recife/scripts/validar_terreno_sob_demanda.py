"""Valida terreno_sob_demanda.py reamostrando os 278 pontos do v12 e
...
from terreno_sob_demanda import sample_terrain_features
...
def run() -> None:
    ...
    for r in rows:
        ...
        for f in FEATS:
            ...
            diffs[f].append(d)
            if d > 0.5:
                mismatches.append({"ponto_id": r["ponto_id"], "variavel": f,
