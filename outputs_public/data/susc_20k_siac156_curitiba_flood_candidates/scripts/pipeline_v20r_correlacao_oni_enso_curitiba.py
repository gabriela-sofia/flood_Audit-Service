...
Uso:
    python pipeline_v20r_correlacao_oni_enso_curitiba.py
"""
...
def main() -> int:
    ...
    leitura = {
        ...
        "ano_com_oni_mais_extremo_jan_jul": max(
            (r for r in rows if r["oni_publicado"]), key=lambda r: abs(r["oni_jan_jul_mean"]))["ano"],
    ...
    (out / "v20r_correlacao_oni_enso.json").write_text(
