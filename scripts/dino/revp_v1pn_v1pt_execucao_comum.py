...
from revp_v1pg_v1pm_representacao_comum import (
...
def build_vector_row_fields() -> list[str]:
    return [
        "embedding_id", "patch_id", "alias", "regiao", "source_run_id",
        ...
        "dino_can_train_model", "dino_target_field_created", "blocked_reason", "notas",
    ]


def make_vector_row(
    idx: int, patch_id: str, alias: str, regiao: str,
    ...
    return {
        ...
        "patch_id": patch_id, "alias": alias, "regiao": regiao,
...
def load_smoke_embeddings(registry_path: Path) -> list[dict[str, Any]]:
    """Devolve os embeddings válidos e não nulos de 768D do variavel store do v1pr."""
    from revp_v1pg_v1pm_representacao_comum import read_csv as _read_csv
    from revp_v1pg_v1pm_representacao_comum import parse_embedding_from_row
