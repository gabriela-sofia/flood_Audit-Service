...
Este script NAO promove nada a negativo, NAO extrai feature e NAO treina.
Ele adquire, inventaria e registra proveniencia.

Uso:
    python scripts/externo/n1_run_all.py
    python scripts/externo/n1_run_all.py --gfd-completo
"""
...
def main() -> int:
    ...
    etapas = [
        ...
        ("n1c_cems_activations.py", [], "C. Copernicus EMS (AOI declarada)"),
    ...
    partes = [
        ...
        "inundada.",
        "",
        "Nenhum negativo foi promovido nesta etapa. Nenhuma feature foi",
