...
NAO faz: nao amostra ponto, nao extrai variavel, nao treina. So adquire.

Uso:
    python scripts/externo/aq_rs01_variaveis.py --sondar
    python scripts/externo/aq_rs01_variaveis.py --baixar
"""
...
def modo_baixar() -> int:
    ...
    (OUT / "PROVENIENCIA.md").write_text(
        ...
        "- Status: AQUISICAO. Nenhuma variavel extraida, nenhum rotulo promovido.\n",
        encoding="utf-8")
    print("===END===")
    return 0
