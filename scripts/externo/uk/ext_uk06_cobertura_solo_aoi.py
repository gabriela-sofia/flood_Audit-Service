...
NAO faz: nao extrai variavel, nao classifica, nao promove rotulo.

Uso:
    python scripts/externo/ext_uk06_cobertura_solo_aoi.py
"""
...
from n1_comum import BASE_OUT, baixar, escrever_proveniencia, gb, salvar_json
